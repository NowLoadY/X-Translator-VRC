...
const DICTIONARY: &[(&str, &str, &str, &str, &str)] = &[
    ...
    ("Open meeting controls", "打开会议控制", "会議コントロールを開く", "회의 제어 열기", "Открыть управление собранием"),
    (
    ...
    ("Open Media Player", "打开视频播放器", "動画プレーヤーを開く", "비디오 플레이어 열기", "Открыть видеоплеер"),
    (
    ...
    (
        "Enable Speaker Recognition & Show Number",
        "启用声纹识别并显示说话人编号",
        "話者認識を有効にして番号を表示",
        "화자 인식을 활성화하고 번호 표시",
        "Включить распознавание и показывать номер",
    ),
    (
        "Enables voiceprint recognition and adds speaker numbers to OSC messages.",
        "启用声纹识别，并在 OSC 消息中添加说话人编号。",
        "声紋認識を有効にし、OSCメッセージに話者番号を追加します。",
        "성문 인식을 활성화하고 OSC 메시지에 화자 번호를 추가합니다.",
        "Включает распознавание голоса и добавляет номера говорящих в сообщения OSC.",
    ),
    (
        "Clear Chatbox",
        "清空聊天框",
